    ...
    <div className="min-h-screen bg-[#F6F7FB]">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              onClick={logout}
              className="inline-flex items-center gap-1.5 rounded-xl px-2.5 py-2 text-sm text-slate-500 hover:bg-slate-100"
            >
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Private to you. Weather follows the city on each card.
        </p>
        ...
        <section className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div
              key={card.label}
              className={`rounded-2xl border border-slate-200 p-4 ${card.dark ? 'bg-slate-900 text-white' : 'bg-white'}`}
            >
          ...
          <div className="flex flex-col gap-3 lg:flex-row">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-3 text-sm outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
